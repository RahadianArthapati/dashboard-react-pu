...
class Search extends Component {
  ...
  render () {
    const { title, size, select, selectOptions, selectProps, style, keyword } = this.props
    ...
    return (
      <Input.Group compact size={size} className={styles.search} style={style}>
        ...
        <Button size={size} type="primary" onClick={this.handleSearch}><Icon type="search" />{title}</Button>
