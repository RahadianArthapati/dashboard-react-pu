...
var Buffered = function (_Component) {
  _inherits(Buffered, _Component);

  function Buffered() {
    _classCallCheck(this, Buffered);

    return _possibleConstructorReturn(this, (Buffered.__proto__ || Object.getPrototypeOf(Buffered)).apply(this, arguments));
  }

  _createClass(Buffered, [{
...
exports.default = (0, _withMediaProps2.default)(Buffered);
